...
//
//import dev.wenslo.wenslo_page.exceptions.RateLimitException;
...
//
//    public static final String ERROR_MESSAGE = "Too many requests at endpoint %s from IP %s! Please try again after %d minutes!";
...
//     */
//    @Before("@annotation(dev.wenslo.wenslo_page.ratelimit.WithRateLimitProtection)")
...
//            throw new RateLimitException(String.format(ERROR_MESSAGE, requestAttributes.getRequest().getRequestURI(), key, (rateDuration / 60000)));
//        }
//    }
//
